import { JPEGStreamer } from "./jpegstreamer/jpegstreamer.js";
...
inputContain.oninput = (event) => {
    jpegStreamer.setScreenFit(jpegStreamer.TV_FIT_TYPES.CONTAIN);
}
inputCover.oninput = (event) => {
    jpegStreamer.setScreenFit(jpegStreamer.TV_FIT_TYPES.COVER);
}
inputFill.oninput = (event) => {
    jpegStreamer.setScreenFit(jpegStreamer.TV_FIT_TYPES.FILL);
}